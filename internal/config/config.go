...
type Config struct {
	...
	PriceAgeThresholdDays int    `env:"PRICE_AGE_THRESHOLD_DAYS" envDefault:"90"`
	...
	LoyaltyDataCompletionBonus   int `env:"LOYALTY_DATA_COMPLETION_BONUS" envDefault:"3"`
	LoyaltyDailyAwardCap         int `env:"LOYALTY_DAILY_AWARD_CAP" envDefault:"20"`
}
